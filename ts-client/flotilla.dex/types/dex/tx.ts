...
export const protobufPackage = "flotilla.dex";
...
export class MsgClientImpl implements Msg {
  ...
  SendSellOrder(request: MsgSendSellOrder): Promise<MsgSendSellOrderResponse> {
    ...
    const promise = this.rpc.request("flotilla.dex.Msg", "SendSellOrder", data);
    return promise.then((data) =>
  ...
  SendBuyOrder(request: MsgSendBuyOrder): Promise<MsgSendBuyOrderResponse> {
    ...
    const promise = this.rpc.request("flotilla.dex.Msg", "SendBuyOrder", data);
    return promise.then((data) =>
