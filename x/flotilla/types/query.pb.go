...
func (*QueryParamsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_57de6f63b6589d30, []int{0}
}
...
func (*QueryParamsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_57de6f63b6589d30, []int{1}
}
...
func init() {
	proto.RegisterType((*QueryParamsRequest)(nil), "flotilla.flotilla.QueryParamsRequest")
	proto.RegisterType((*QueryParamsResponse)(nil), "flotilla.flotilla.QueryParamsResponse")
}

func init() { proto.RegisterFile("flotilla/query.proto", fileDescriptor_57de6f63b6589d30) }

var fileDescriptor_57de6f63b6589d30 = []byte{
	// 279 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x12, 0x49, 0xcb, 0xc9, 0x2f,
	0xc9, 0xcc, 0xc9, 0x49, 0xd4, 0x2f, 0x2c, 0x4d, 0x2d, 0xaa, 0xd4, 0x2b, 0x28, 0xca, 0x2f, 0xc9,
	...
	0x54, 0x16, 0xa4, 0x16, 0x27, 0xb1, 0x81, 0xc3, 0xc9, 0x18, 0x10, 0x00, 0x00, 0xff, 0xff, 0x58,
	0x32, 0x7b, 0xb2, 0xc9, 0x01, 0x00, 0x00,
}
...
func (c *queryClient) Params(ctx context.Context, in *QueryParamsRequest, opts ...grpc.CallOption) (*QueryParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/flotilla.flotilla.Query/Params", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Params_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/flotilla.flotilla.Query/Params",
	}
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "flotilla.flotilla.Query",
